      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="relative w-72">
          ...
          <input
            ...
            className="w-full border border-gray-300 bg-gray-50 text-gray-800 pl-10 pr-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
          />
        ...
        <table className="min-w-full text-sm text-left">
          ...
          <thead className="bg-gray-100 text-gray-700">
            ...
            <tr>
              ...
              <th onClick={() => handleSort("priority")} className="px-4 py-3 cursor-pointer">
                Priority
              </th>
